...
# Continue's subtitle is "Resume your save - v{version} ({build})" in the asset
...
default_titles="New Game=Start a fresh run|Continue=Resume your save - v1.4.0 (37)|Daily Reward=Claim today's gift"
