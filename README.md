...
This is **0.4.7**, a pre-1.0 release. Here is exactly what has been proven and
...
```
https://github.com/emindeniz99/unity-quick-actions.git#v0.4.7
```
...
```json
{
  ...
  "dependencies": {
    "com.emindeniz99.quick-actions": "0.4.7"
  }
}
```
