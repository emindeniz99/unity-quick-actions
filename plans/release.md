...
| Unit tests | ✅ 31 passing (dotnet) + 2 Unity-only = 33 authored | `dotnet test` (list logic, validity, equality, icon pin, dispatch, reconcile, ordering, drain, last-performed) |
